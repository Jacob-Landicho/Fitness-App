                                      ...
                                      ...meals[selectedMealDayForHomePage!]?.map((meal) {
                                        ...
                                        return Padding(
                                          ...
                                          child: Dismissible(
                                            ...
                                            child: ElevatedButton(
                                              onPressed: () {
                                                // Your existing code when the button is pressed
                                              },
                                              child: Text(matchingActivity.name),
                                              style: ButtonStyle(
                                                backgroundColor: MaterialStateProperty.all<Color>(
    ...
    return Padding(padding: EdgeInsets.only(left: leftPadding, right: rightPadding, top: topPadding, bottom: bottomPadding),
      child: Card(
        ...
        child: Container(
          ...
          // Card colours
          decoration: BoxDecoration(
            // color: Theme.of(context).brightness == Brightness.dark ? Colors.black54 : Colors.greenAccent, // Text color
            ...
            //color: Colors.greenAccent, // Use a solid color
          ),
